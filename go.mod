module github.com/warnakulasuriya-fds-e23/fingerprint-go-client

go 1.24.4

require (
	github.com/warnakulasuriya-fds-e23/fingerprint-go-sdk v0.0.3-0.20250620074544-29113a973756
